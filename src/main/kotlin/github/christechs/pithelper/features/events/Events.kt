...
enum class Events(val eventName: String, val duration: Long, val colour: Color) {
    ...
    SQAUDS("Squads", 5 * 60000, Color(85, 255, 255, 100)),
    BEAST("Beast", 5 * 60000, Color(255, 85, 85, 100)),
    PIZZA("Pizza", 5 * 60000, Color(255, 255, 85, 100)),
    RAGE_PIT("Rage Pit", 4 * 60000, Color(139, 13, 13, 100)),
    SPIRE("Spire", 5 * 60000, Color(18, 12, 12, 100)),
    ROBBERY("Robbery", 4 * 60000, Color(165, 42, 42, 100)),
    BLOCKHEAD("Blockhead", 5 * 60000, Color(124, 252, 0, 100)),
    RAFFLE("Raffle", 5 * 60000, Color(175, 115, 74, 100)),
    TEAM_DEATHMATCH("Team Deathmatch", 4 * 60000, Color(0, 0, 0, 100)),
