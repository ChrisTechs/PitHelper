...
import io.github.christechs.pithelper.ui.screen.CustomProfileViewerScreen;
...
public class ViewInvCommand extends CommandBase {

    public static void register() {
        ClientCommandHandler.instance.registerCommand(new ViewInvCommand());
    }
